...
def can_place_x_y(board, stone, x, y):
    if board[y][x] != 0:
        return False
@@ -26,19 +29,22 @@ def can_place_x_y(board, stone, x, y):
...
@@ -53,39 +59,42 @@ def apply_move(board, stone, x, y):
...
class weareteamphysAI:
    ...
    def evaluate_board(self, board):
        ...
        score = 0
@@ -96,7 +105,8 @@ def evaluate_board(self, board):
...
@@ -106,21 +116,28 @@ def minimax(self, board, depth, stone, maximizing_player):
